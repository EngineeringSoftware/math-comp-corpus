...
From mathcomp Require Import ssrnum rat closed_field polyrcf matrix.
...
Lemma derive1mx_rot (p' : 'rV[R^o]_3) :
...
Lemma dp (q : R^o -> 'rV[R^o]_n) t :
  derive1mx (p \o q) t = derive1mx q t *m Jp (q t).
Proof.
