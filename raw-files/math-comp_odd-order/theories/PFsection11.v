...
have tau_alpha i: tau (alpha_ i j) = eta_ i j - eta_ i 0 - n *: zeta1.
  ...
  have{psi_phi} col0_beta: '[eta_col 0, beta] = a.
  ...
  have{nY Da} defX: X = eta_ i j - eta_ i 0.
...
Lemma FTtype34_structure (eta0row := \sum_j eta_ 0 j) :
  [/\ {in S1, forall zeta, eq_proj_eta (tau (bridge0 zeta)) eta0row}, (p < q)%N
    & FTtype M == 3 /\ typeP_Galois MtypeP].
Proof.
