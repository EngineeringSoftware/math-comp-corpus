...
Lemma Msigma_setI_mmax_central p H :
 ...
 [/\ forall P, P \subset M :&: H -> p.-group P ->
           P \subset 'C(M`_\sigma :&: H), p \notin \tau2(H)
   & p \in \tau1(M) -> p \in \beta(G)].
Proof.
...
Corollary cent_norm_tau13_mmax p P H :
 ...
 [/\ forall P1, P1 \subset M :&: H -> p.-group P1 ->
           P1 \subset 'C(M`_\sigma :&: H), forall X, X \subset E :&: H -> \tau1(H)^'.-group X ->
...
Lemma tau1_mmaxI_asymmetry M Mstar p P q Q q_star Qstar : [/\ M \in 'M, Mstar \in 'M & gval Mstar \notin M :^: G] -> [/\ p \in \tau1(M), p \in \tau1(Mstar) & P \in 'E_p^1(M :&: Mstar)] -> [/\ q.-Sylow(M :&: Mstar) Q, q_star.-Sylow(M :&: Mstar) Qstar,
            P \subset 'N(Q) & P \subset 'N(Qstar)] -> 'C_Q(P) = 1 /\ 'C_Qstar(P) = 1 -> 'N(Q) \subset Mstar /\ 'N(Qstar) \subset M ->
  False.
Proof.
move: Mstar q_star Qstar => L u U.
move=> [maxM maxL notMGL] [t1Mp t1Lp EpP] [sylQ sylU nQP nUP].
move=> [regPQ regPU] [sNQL sNUM]; rewrite setIC in sylU.
have notLGM: gval M \notin L :^: G by rewrite orbit_sym.
...
Theorem tau13_regular M E E1 E2 E3 p P :
  ...
  [/\ semiregular E3 E1, semiregular M`_\sigma E3
    & 'C_(M`_\sigma)(P) != 1].
Proof.
...
Corollary tau13_nonregular M E E1 E2 E3 :
  ...
  [/\ E1 :!=: 1, E3 ><| E1 = E, semiprime M`_\sigma E
    & forall X, X \in 'E^1(E) -> X <| E].
Proof.
